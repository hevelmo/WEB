            ...
            $panelTabs      = $('.td-tab');
                ...
                $.test_drive_select_car = function( k ){
                    var car_data    = get_car_data( k ),
                        ...
                        $car_texts  = $('#car_select_name h3, #td_concessionaire_car h3, #td_form_car h3, #td_final_car h3, #fr_model_car');
...
//                        total_pay       =  funding_data.price -  f_amount,
                ...
                $.funding_select_car = function( k ){
                    var car_data    = get_car_data( k ),
                        ...
                        $car_texts  = $('#car_select_name h3, #step-nav-tab h3, #fu_adjust_car h3, #funding_result_data h3, #funding-resume-car h3, #fr_model_car');
